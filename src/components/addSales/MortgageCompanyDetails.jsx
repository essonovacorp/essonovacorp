...
export default function MortgageCompanyDetails() {
    return (
        <div>
            <form class="form-group">
                <div className="row">
                    <div className="col-md-7">
                        <h5 className='fw-bold text-dark mb-3'>Mortgage Company Details</h5>
                    </div>
                    <div className="col-md-7">
                ...
                <div className="row">
                    <div className="col-md-7">
                        <div className="mb-3 pe-3">
                            <label for="loanOfficer" className="form-label">Loan Officer</label>
                            <Input size="lg" placeholder="" id="loanOfficer" disabled />
                        </div>
                    </div>
                    <div className="col-md-7">
                        <div className="mb-3 pe-3">
